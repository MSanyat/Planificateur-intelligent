...
import mining.data_mining as dm  
...
def get_spark_context():
    ...
    conf.setMaster('spark://192.168.127.1:7077')
...
'''
[df_cities, df_types, df_placeTypes, df_similarities, df_places] = init_matrix()
[overall_score, score_table]=get_classement(df_placeTypes, tab_tags, df_types, df_similarities, df_cities)
villes = get_way(tab_tags, overall_score, 3, df_cities)
print(villes)
'''